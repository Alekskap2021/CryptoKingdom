...
**Does not belong:** Code that is genuinely reused in 2+ pages (extract only when the team agrees).
...
For framework-specific alias configuration (Vite, Next.js, Nuxt), see `references/framework-integration.md`.
